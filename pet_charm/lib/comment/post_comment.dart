...
class PostComment extends StatefulWidget {
  const PostComment({Key? key, required this.postId}) : super(key: key);
  ...
  _upLoadImg() async {
    try {
      ...
      formData = FormData.fromMap({
        ...
        "commentContent": _postController.text,
      });

      var response = await Global.dio.post('comment/', data: formData);
