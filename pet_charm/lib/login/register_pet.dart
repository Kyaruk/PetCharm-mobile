...
class _RegisterPet extends State<RegisterPet> {
  ...
  List<DropdownMenuItem<String>> genderItemList() {
    const DropdownMenuItem<String> item1 =
        DropdownMenuItem(child: Text('男孩子'), value: '男孩子');
    const DropdownMenuItem<String> item2 =
        DropdownMenuItem(child: Text('女孩子'), value: '女孩子');
    const DropdownMenuItem<String> item3 =
        DropdownMenuItem(child: Text('其他'), value: '其他');
    final List<DropdownMenuItem<String>> items = <DropdownMenuItem<String>>[
      item1,
  ...
  void submitPetInfo() {
    if (selectItemValue == null) {
      toast("请选择您的宠物种类");
    } else if (genderSelectItemValue == null) {
      toast("请选择您的宠物性别");
    } else {
      setState(() {
        petInfo = true;
  ...
  _checkPetForm() async {
    FormData formData = FormData.fromMap({
      ...
      "petGender": genderSelectItemValue,
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              subtitle: Text(genderSelectItemValue),
            ),
            ListTile(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Container(
                          padding: EdgeInsets.only(
                              left: Global.deviceSize.width * 0.025,
                              right: Global.deviceSize.width * 0.025),
                          decoration: const BoxDecoration(
                              border: Border(
                                  bottom: BorderSide(
                                      color: Color.fromRGBO(250, 250, 250, 1),
                          ...
                          child: Card(
                              ...
                              child: Container(
                                ...
                                child: DropdownButton<String>(
                                  ...
                                  onChanged: (var value) {
                                    setState(() {
                                      genderSelectItemValue = value;
                                    });
                                  },
                                  value: genderSelectItemValue,
                                ),
                                // ),
                              )),
                        ),
